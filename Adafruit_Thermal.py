...
class Adafruit_Thermal:
    ...
    def __init__(self, bus=1, baudrate=9600, pins=None, uart=None, **kwargs):
        ...
        if uart is not None:
            ...
            UART(bus, baudrate=baudrate, stop=1, **extra_options)
            ...
            if char != 0x13:
                ...
                if (char == "\n") or (self.column == self.maxColumn):
                    ...
                    if self.prevByte == "\n":
                        ...
                        d += int(
                            (
                                (self.charHeight * self.dotPrintTime)
    ...
    def printBitmap(self, w, h, bitmap, LaaT=False):
        ...
        if LaaT:
            ...
            maxChunkHeight = (
                50  # lower max chunk (not 255) for memory-constrained systems (LoPy v1)
            )
